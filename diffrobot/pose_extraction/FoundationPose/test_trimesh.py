...
mesh_path = '/home/krishan/work/2024/repos/diffrobot/diffrobot/pose_extraction/FoundationPose/demo_data/spoon/mesh/mesh.obj'

original_mesh = trimesh.load(mesh_path)

# Scale the mesh to 7% of its original size
scaled_mesh = original_mesh.copy()
scaling_factor = 0.11 # 7 for cup; 11 for teapot; 7 for all others
